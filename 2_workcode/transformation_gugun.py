...
# MongoDB meta에 기록
def record_mongo(unique_id, viewname, kpi, native, dimension, type, period, spatial, gugun):
    # MongoDB 연결 설정
...
def Insert_to_mongo():
    ...
    for object in filtered_objects:
        ...
        for gugun, gugun_data in guguns_data.items():
            ...
            record_mongo(unique_id, view_name, kpi, native, dimension, type, period, spatial, gugun)
