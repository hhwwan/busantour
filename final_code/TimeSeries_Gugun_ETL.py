...
def transform_task(ti):
    ...
    pickle_folder = "TimeSeries_Gugun_pickle_files"  # 폴더 이름
...
def load_task(ti, collection_name):
    ...
    pickle_folder = "TimeSeries_Gugun_pickle_files"
    ...
    try:
        for pickle_filepath in transformed_data_paths:
            ...
            gugun_code = get_code_mapping("gugun").get(gugun)

            # MongoDB안의 'meta'에 기록
            record_mongo(mongo_db, collection_name, unique_id, view_name, objecttype, spatiallevel, kpi, nationality, dimension, gugun_code, adong_code=None, attraction_code=None)
