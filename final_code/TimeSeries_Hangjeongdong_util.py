...
# MongoDB meta에 기록
def record_mongo(mongo_db, mongo_collection, unique_id, viewname, objecttype, spatiallevel, kpi, nationality, dimension, gugun_code, adong_code, attraction_code=None):
    # MongoDB 연결 설정
