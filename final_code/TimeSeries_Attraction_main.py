...
from TimeSeries_Attraction_ETL import extract_task, transform_task, load_task, resister_task

# collection 이름 지정
collection_name = "TA202201202312"
...
dag = DAG(
    dag_id="TimeSeries_Attraction_ETL",
